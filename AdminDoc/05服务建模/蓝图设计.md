...
2.  蓝图列表可以按照名称、状态、创建时间排序，也可以按照蓝图名称进行搜索
...
1.  验证蓝图：点击左上角验证，验证蓝图，提示这是一个合法的蓝图

2.  保存蓝图：验证成功后点击左上角保存，保存成功后点击返回，将回到蓝图列表界面

3.  发布蓝图：在蓝图列表里选择刚编辑的OpenStack
    Firewall蓝图，点击发布，然后点击是

4.  蓝图发布成功，状态变为已发布，Openstack
    Firewall虚拟机蓝图创建成功

5.  也可在验证成功后，直接点击保存并发布，发布蓝图
...
10. 蓝图发布成功，状态变为已发布，蓝图创建成功，也可在验证成功后，直接点击保存并发布，发布蓝图
